...
| [[Probability Mass Function]]                 | $$f(k,n,p)= {n \choose k}p^{k}(1-p)^{n-k}~~~~~\text{where }{n\choose k}=\frac{n!}{k!(n-k)!}$$                                                                                              |
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [[Cumulative Distribution Function]]          | $$f_{X}(k)=P(X \le k)=\sum_{x=0}^{k}{n \choose x}p^{x}(1-p)^{n-x}=I_{1-p}(n-k,k+1)=\frac{\displaystyle\int_{0}^{x}t^{n-k-1}(1-t)^{k}~dt}{\displaystyle\int_{0}^{1}t^{n-k-1}(1-t)^{k}~dt}$$ |
