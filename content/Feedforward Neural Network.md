...
tags:
---
A feedforward neural network is a type of [[Neural Network|neural network]] architecture which involves an input layer, some set of hidden layers and an output layer where information in the network only travels in a single direction: from input to output.

## Architecture

Below is an example of a simple feedforward neural network:

![[assets/nn.png|384x347]]
