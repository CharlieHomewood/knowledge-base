...
For classification, we can choose splitting criterion which minimises [[Entropy (Loss Function)|entropy]] (i.e. maximises [[Information Gain|information gain]]). Minimising entropy means selecting the feature and splitting criterion which pools as much of the data into one group as possible. We can similarly use [[Gini Impurity|Gini impurity]] as well.
